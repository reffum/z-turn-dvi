...
#
# project.tcl: Tcl script for re-creating project 'z-turn-dvi'
#
# Generated by Vivado on Tue Jul 23 19:57:38 +0300 2019
...
#
#    "C:/MyWork/Projects/dvi/src/design_1.bd"
#    "C:/MyWork/Projects/dvi/src/design_1_wrapper.v"
#    "C:/MyWork/Projects/dvi/src/top.xdc"
#    "C:/MyWork/Projects/dvi/sim/tb.sv"
#
#*****************************************************************************************
...
set _xil_proj_name_ "z-turn-dvi"
...
set orig_proj_dir "[file normalize "$origin_dir/z-turn-dvi"]"
...
set_property -name "compxlib.modelsim_compiled_library_dir" -value "C:/Xilinx/Vivado/libs/zynq/modelsim" -objects $obj
...
set_property -name "webtalk.modelsim_launch_sim" -value "6" -objects $obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/src/top.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7z010clg400-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/src/top.xdc"]" -objects $obj
...
# Create 'impl_1_route_report_timing_summary_1' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs impl_1] impl_1_route_report_timing_summary_1] "" ] } {
  create_report_config -report_name impl_1_route_report_timing_summary_1 -report_type report_timing_summary:1.0 -steps route_design -runs impl_1
}
set obj [get_report_configs -of_objects [get_runs impl_1] impl_1_route_report_timing_summary_1]
if { $obj != "" } {
set_property -name "is_enabled" -value "0" -objects $obj
